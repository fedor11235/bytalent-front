<template>
  <div ref="apleAuth" class="aple-auth">
    <button ref="buttonAple" id="sign-in-with-apple-button"> Sign In with Apple </button>
...
onMounted(() => {
  ...
  script.setAttribute('src', 'https://appleid.cdn-apple.com/appleauth/static/jsapi/appleid/1/en_US/appleid.auth.js');
