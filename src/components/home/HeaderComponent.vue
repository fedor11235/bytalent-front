<template>
  <div class="header">
    <div class="header__logo" :style="{backgroundImage: `url(${require(`@/assets/${logo}.png`)})`}"></div>
    <div class="header__line-left" :style="{backgroundImage: `url(${require(`@/assets/${lineLeft}.png`)})`}"></div>
    <ButtonComponent :url="urlButton" :urlHover="urlButtonHover"/>
    <div class="header__line-right" :style="{backgroundImage: `url(${require(`@/assets/${lineRight}.png`)})`}"></div>
